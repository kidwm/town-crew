...
export function mountUI(app: HTMLElement, dev: boolean) {
  ...
  ${dev ? `<aside class="dev-panel" aria-label="開發工具">
    ...
    <div class="divider"></div>
    <dl class="telemetry"><div><dt>目前階段</dt><dd id="phase"></dd></div><div><dt>動作</dt><dd id="action"></dd></div><div><dt>清除碎石</dt><dd id="rocks"></dd></div><div><dt>整平趟數</dt><dd id="passes"></dd></div><div><dt>車斗角度</dt><dd id="angle"></dd></div><div><dt>首次可操作</dt><dd id="boot-time">—</dd></div></dl>
